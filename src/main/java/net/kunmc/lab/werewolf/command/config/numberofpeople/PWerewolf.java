...
public class PWerewolf extends Command {
    public PWerewolf() {
    ...
    public void execute(@NotNull CommandContext ctx) {
        try {
            int value = Roles.WEREWOLF.numberOfPeople((int)ctx.getTypedArgs().get(0));
            ConfigManager.setConfig(ConfigPathConst.PEOPLE_WEREWOLF, value);
            ctx.success(Roles.WEREWOLF.jName + "の人数を" + value + "人に設定しました。");
