...
public class CommandNameConst {
    public static final String COMMAND_MAIN = "werewolf";
    public static final String COMMAND_START = "start";
    public static final String COMMAND_STOP = "stop";
    public static final String COMMAND_ADD_PLAYER = "addplayer";
    public static final String COMMAND_REMOVE_PLAYER = "removeplayer";
    ...
    public static final String COMMAND_SEER = "seer";
