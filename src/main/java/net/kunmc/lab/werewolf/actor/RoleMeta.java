...
public enum RoleMeta {
    ...
    RoleMeta(String jName, Teams team, RoleBuilder builder, int numberOfPeopleMin, int numberOfAbilitiesMin, boolean isInhuman, boolean haveAbility, String abilityDescription) {
        this.jName = jName;
        this.team = team;
